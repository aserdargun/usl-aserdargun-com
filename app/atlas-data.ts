...
export const glossary: Record<Locale, Record<string, GlossaryEntry>> = {
  tr: {
    ...
    "lora": { tr: { term: "LoRA", short: "Düşük-rank adaptör", long: "Donmuş bir W matrisine küçük bir ölçek × BA düzeltmesi ekleyerek eğitilebilir parametre sayısını düşüren yöntem." }, en: { term: "LoRA", short: "Low-Rank Adaptation", long: "A method that adds a small scale × BA correction to a frozen W matrix to reduce trainable parameters." } },
